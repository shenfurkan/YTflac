"""
SpotiFLAC â€” Modulo Python per il download di musica in alta fedeltÃ .

Uso minimo:
    from ytflac import SpotiFLAC
...
def SpotiFLAC(
    ...
    Args:
        ...
        services: Provider audio in ordine di prioritÃ  ("tidal", "qobuz", "amazon").
        ...
        quality: QualitÃ  audio desiderata ("LOSSLESS" o "HI_RES").
    ...
    opts = DownloadOptions(
        ...
        or ["spotify", "musixmatch", "lrclib", "apple"],
    ...
    try:
        ...
        logging.getLogger("SpotiFLAC").error(
            "Errore critico durante l'esecuzione: %s", e
        )
